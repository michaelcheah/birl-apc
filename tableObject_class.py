...
class TableObject(object):
    ...
    def print_object_attributes(self, children_info=False):
        ...
        for attr in object_attr:
            if attr != 'children_info' and attr != "nuclear":
    ...
    def label_object(self, image, name=None, show=True):
        out = TableObject.filter_object(self, image)
        if show:
    ...
    def display_object(self, image, name=None, show_contour=True):
        out = TableObject.filter_object(self, image, show_contour=show_contour)
        plt.figure(str(self.name))
        plt.imshow(out)
        plt.show()
